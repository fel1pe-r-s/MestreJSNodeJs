...
- **Autenticação&autorização**
    - [Erros de auth](02_Areas/Autenticação&autorização/Erros de auth.md)
    - [Jwt](02_Areas/Autenticação&autorização/Jwt.md)
    - [Permissionamento](02_Areas/Autenticação&autorização/Permissionamento.md)
- **Bun**
    - [Bun_Runtime](02_Areas/Bun/Bun_Runtime.md)
- **C**
    - [Linguagem_C](02_Areas/C/Linguagem_C.md)
- **Database**
    - [Prisma](02_Areas/Database/Prisma.md)
    - **Postgresql**
        - [Comandos](02_Areas/Database/Postgresql/Comandos.md)
        - [Postgresql docker](02_Areas/Database/Postgresql/Postgresql docker.md)
        - [Postgresql](02_Areas/Database/Postgresql/Postgresql.md)
- **Deno**
    - [Deno_Runtime](02_Areas/Deno/Deno_Runtime.md)
- **Deploy**
    - [AWS](02_Areas/Deploy/AWS.md)
    - [Docker](02_Areas/Deploy/Docker.md)
- **Docker**
    - [Comandos](02_Areas/Docker/Comandos.md)
    - [Docker](02_Areas/Docker/Docker.md)
    - [DockerFile](02_Areas/Docker/DockerFile.md)
    - [Install](02_Areas/Docker/Install.md)
    - [docker compose](02_Areas/Docker/docker compose.md)
- **Framework**
    - [Cache](02_Areas/Framework/Cache.md)
    - [Express](02_Areas/Framework/Express.md)
    - [Fastify](02_Areas/Framework/Fastify.md)
    - [Nest-js](02_Areas/Framework/Nest-js.md)
    - [decoreito no Nest](02_Areas/Framework/decoreito no Nest.md)
- **GitGithub**
    - [CI CD](02_Areas/GitGithub/CI CD.md)
    - [Git](02_Areas/GitGithub/Git.md)
    - [GitHub Actions](02_Areas/GitGithub/GitHub Actions.md)
    - [Monorepo](02_Areas/GitGithub/Monorepo.md)
    - [TurboRepo](02_Areas/GitGithub/TurboRepo.md)
- **Go**
    - [Linguagem_Go](02_Areas/Go/Linguagem_Go.md)
- **JavaScript**
    - [JavaScript](02_Areas/JavaScript/JavaScript.md)
- **Libs**
    - [CASL](02_Areas/Libs/CASL.md)
    - [Date-fns](02_Areas/Libs/Date-fns.md)
    - [FackerJs](02_Areas/Libs/FackerJs.md)
    - [Zod](02_Areas/Libs/Zod.md)
    - [dayjs](02_Areas/Libs/dayjs.md)
- **Network**
    - [HTTP](02_Areas/Network/HTTP.md)
    - [HTTPS](02_Areas/Network/HTTPS.md)
    - [Imagem  ilustrativa da rede de computadores](02_Areas/Network/Imagem  ilustrativa da rede de computadores.md)
    - [URL](02_Areas/Network/URL.md)
    - [Web](02_Areas/Network/Web.md)
- **Nextjs**
    - [Next-Auth](02_Areas/Nextjs/Next-Auth.md)
    - [Nextjs](02_Areas/Nextjs/Nextjs.md)
    - [Server C&A](02_Areas/Nextjs/Server C&A.md)
- **Node**
    - [Node](02_Areas/Node/Node.md)
    - [NodeJS_Runtime](02_Areas/Node/NodeJS_Runtime.md)
- **Programação**
    - [Condições de corrida](02_Areas/Programação/Condições de corrida.md)
    - [EITHER Tratando erros.](02_Areas/Programação/EITHER Tratando erros..md)
    - [Estrutura de dados](02_Areas/Programação/Estrutura de dados.md)
    - **javaScript**
        - [Algoritmos Binary Search](02_Areas/Programação/javaScript/Algoritmos Binary Search.md)
        - [DataType](02_Areas/Programação/javaScript/DataType.md)
        - [Throw Exceptions](02_Areas/Programação/javaScript/Throw Exceptions.md)
        - [Variáveis ​​JavaScript](02_Areas/Programação/javaScript/Variáveis ​​JavaScript.md)
        - [WatchedList](02_Areas/Programação/javaScript/WatchedList.md)
        - [Web API](02_Areas/Programação/javaScript/Web API.md)
        - **TypeScript**
            - [Decoreitor no TypeScript](02_Areas/Programação/javaScript/TypeScript/Decoreitor no TypeScript.md)
            - [TypeScript](02_Areas/Programação/javaScript/TypeScript/TypeScript.md)
            - [optional.ts](02_Areas/Programação/javaScript/TypeScript/optional.ts.md)
- **React**
    - [Propriedades](02_Areas/React/Propriedades.md)
    - [React-Hook-Form](02_Areas/React/React-Hook-Form.md)
    - [React](02_Areas/React/React.md)
    - [SuspensApi](02_Areas/React/SuspensApi.md)
    - [UseEffect](02_Areas/React/UseEffect.md)
    - [UseMemo](02_Areas/React/UseMemo.md)
    - [react-query](02_Areas/React/react-query.md)
    - [redux](02_Areas/React/redux.md)
- **SaaS**
    - [Micro SaaS](02_Areas/SaaS/Micro SaaS.md)
    - [SaaS](02_Areas/SaaS/SaaS.md)
- **Tests**
    - [Tests](02_Areas/Tests/Tests.md)
    - [cypress](02_Areas/Tests/cypress.md)
    - [vitest](02_Areas/Tests/vitest.md)
- **TypeScript**
    - [TypeScript](02_Areas/TypeScript/TypeScript.md)
- **pagina statica**
    - [Html](02_Areas/pagina statica/Html.md)
    - [tailwind](02_Areas/pagina statica/tailwind.md)
- **patterns**
    - [Clean Architecture](02_Areas/patterns/Clean Architecture.md)
    - [Composição](02_Areas/patterns/Composição.md)
    - [DDD](02_Areas/patterns/DDD.md)
    - [Inversão de dependências](02_Areas/patterns/Inversão de dependências.md)
    - [Polymorphise](02_Areas/patterns/Polymorphise.md)
    - [mappers](02_Areas/patterns/mappers.md)
    - [patterns](02_Areas/patterns/patterns.md)
### [03_Arquivos](03_Arquivos/)
Recursos gerais, backups e arquivos que não se encaixam nas outras categorias.
...
* **Links**: Utilize `[[link]]` ou `[link](path)` para referenciar outros arquivos.
* **Fluxo**:
    1. Novos estudos vão para `00_Entrada`.
    2. Ao aprofundar, mova para `02_Areas` ou inicie um `01_Projeto`.
