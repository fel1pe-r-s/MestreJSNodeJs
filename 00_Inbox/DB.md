...
**Tags**: `#DB` `#Backend` `#SQL` `#NoSQL`

---

## 🐘 PostgreSQL
O PostgreSQL é um banco de dados relacional (SQL) robusto e extensível.

### 🐳 Rodando com Docker
```bash
docker run --name pg-db -e POSTGRES_PASSWORD=minhasenha -p 5432:5432 -d postgres
```

---

## ◭ Prisma (ORM)
O Prisma facilita a comunicação com o banco de dados usando TypeScript.
